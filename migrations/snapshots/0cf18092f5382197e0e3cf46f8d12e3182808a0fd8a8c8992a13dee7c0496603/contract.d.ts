...
export type StorageHash =
  StorageHashBase<'0cf18092f5382197e0e3cf46f8d12e3182808a0fd8a8c8992a13dee7c0496603'>;
export type ExecutionHash =
  ExecutionHashBase<'15524ed120e57ad0a0290a23d3341edb4d3ef486c284837b97a48785638a6821'>;
...
export type FieldInputTypes = {
  readonly public: {
    readonly Conversation: {
      ...
      readonly workspaceId: CodecTypes['sql/char@1']['input'];
...
export namespace Models {
  export type public_User = {
    ...
    workspaceMembers: public_WorkspaceMember[];
    readonly [RelationKeys]?: 'workspaceMembers';
  };
  export type public_Workspace = {
    ...
    readonly [RelationKeys]?: 'members' | 'conversations' | 'documents';
  };
  ...
  export type public_Conversation = {
    ...
    readonly [RelationKeys]?: 'workspace' | 'messages';
  };
          ...
          readonly table: {
            ...
            readonly WorkspaceMember: {
              columns: {
                ...
                readonly role: {
                  readonly nativeType: 'WorkspaceMemberRole';
                  readonly codecId: 'pg/enum@1';
                  readonly nullable: false;
                  readonly typeParams: { readonly typeName: 'WorkspaceMemberRole' };
                };
                readonly createdAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
              ...
              indexes: readonly [
                {
                  readonly name: 'WorkspaceMember_userId_workspaceId_idx_fa32762a';
                  readonly prefix: 'WorkspaceMember_userId_workspaceId_idx';
